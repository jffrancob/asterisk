...
#curl -vsL -u ${AUTH_USER-jfranco}:${AUTH_PASS-msvprvnt} https://dev.ikono.com.co/downloads/asterisk/asterisk-${ASTERISK_VERSION}_rsp-13.tar.gz | tar --strip-components 1 -xz
